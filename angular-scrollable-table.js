(function (angular) {
    ...
    angular.module('scrollable-table', [])
        .run(['$templateCache', function($templateCache){
            ...
            $templateCache.put('scrollable-table/scrollable-table.tpl.html',
        ...
        .directive('scrollableTable', ['$timeout', '$q', '$parse', function ($timeout, $q, $parse) {
            return {
                ...
                templateUrl: 'scrollable-table/scrollable-table.tpl.html',
                    ...
                    this.doSort = function (comparatorFn) {
                        if (comparatorFn) {
                            $scope.rows.sort(function (r1, r2) {
                                var compared = comparatorFn(r1, r2, $scope.sortExpr);
        ...
        .directive('sortableHeader', [function () {
            return {
                ...
                templateUrl: 'scrollable-table/sortalbe-header.tpl.html',
